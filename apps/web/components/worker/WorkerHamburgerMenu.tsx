...
export function WorkerHamburgerMenu({ firstName }: Props) {
  ...
  const items = [
    ...
    },
    {
      ...
      action: () => go('/w/stocktake'),
    },
    {
      label: 'KITCHEN',
      sub: 'TODAY\'S ORDERS',
      icon: (
        <path strokeLinecap="square" strokeWidth={1.5} d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
      ),
      action: () => go('/w/kitchen'),
    },
  ]
